...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:d="http://docbook.org/ns/docbook" xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0" version="1.0">
  ...
  <xsl:template name="user.pagemasters">
    <fo:simple-page-master margin-right="0in" margin-left="0in" margin-bottom="0in" margin-top="0in" page-height="{$page.height}" page-width="{$page.width}" master-name="fullpage">
      <xsl:choose>
        <xsl:when test="$draft.mode='yes'">
          <fo:region-body background-color="lightgrey" margin-bottom="0in" margin-top="0in" margin-left="0in" margin-right="0in"/>
          <fo:region-before background-color="lightgrey" extent="0pt" display-align="after" region-name="xsl-region-before-first"/>
